        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" id="formgallery" method="POST" enctype="multipart/form-data">
                            @csrf
                            <h6 class="heading-small text-muted mb-4">Data</h6>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <input name="id" value="{{$paket->id}}" hidden>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="namaPaket">Nama Paket</label>
                                            <input type="text" id="namaPaket" name="namaPaket" required value="{{$paket->nama}}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="hargaPaket" name="hargaPaket" required value="{{number_format($paket->harga,0)}}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="deskripsiPaket" name="deskripsiPaket" rows="3" required>{{$paket->deskripsi}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 mt-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <select class="form-control" id="penginapanSelect" name="penginapan" onchange="setTour()">
                                                    <option value="">Pilih Penginapan</option>
                                                    @foreach($penginapan as $p)
                                                        <option value="{{ $p->id }}" {{$paket->penginapan->id == $p->id ? 'selected' : ''}}>{{ $p->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <a>Foto</a>
                                        <input name="idImg" value="{{$paket->getImage[0]->image->id}}" hidden>
                                        <div class="">
                                            <input type="file"  onchange="" id="image" class="image" data-min-height="10"
                                                   data-height="150"  data-default-file="{{ $paket->getImage[0]->image->url }}"
...
@section('script')
    ...
    <script>
        ...
        function setTour() {
            ...
            select.empty();
            $.get('/admin/paket/get-tour/' + $('#penginapanSelect').val(), function (data) {
        ...
        function value_tour() {
            ...
            $.get('/admin/paket/get-tour/' + $('#penginapanSelect').val(), function (data) {
                ...
                @foreach($paket->paketTour as $key => $value )
                    selectTour['{{$key}}'] = '{{$value->tour_id}}';
                @endforeach
                $('#tourSelect').val(selectTour).select2();
            });
