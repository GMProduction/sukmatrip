            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Detail Data Artikel</h6>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" id="judulArtikel" name="judulArtikel"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea readonly class="form-control" id="kontenArtikel" rows="3"></textarea>
                                        </div>
                                    </div>

                                    <div class="col-lg-12 mb-4">
                                        <a class="d-block">Gambar</a>
