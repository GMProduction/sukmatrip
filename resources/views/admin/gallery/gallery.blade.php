            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-8 col-8 text-right">
                        <a href="/admin/gallery/add" class="btn btn-md btn-neutral">Tambah</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(function () {
        ...
        $('#tabel tbody').on('click', 'a#deleteData', function () {
            ...
            var nama = data['judul'];
            Swal.fire({
                title: 'Apa anda yakin untuk menghapus data gallery ' + nama + ' ?',
                icon: 'warning',
                ...
                if (result.value) {
                    ...
                    if (get['status'] === 200) {
                        ...
                        Swal.fire({
                            title: 'Success',
                            text: 'Berhasil Menghapus Data gallery ' + nama,
                            icon: 'success',
