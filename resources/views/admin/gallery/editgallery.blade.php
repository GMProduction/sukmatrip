                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formgallery" method="POST" enctype="multipart/form-data">
                            ...
                            <input hidden name="id" value="{{$gallery->id}}">
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="namaGallery">Nama Gallery</label>
                                            <input type="text" id="namaGallery" name="namaGallery" value="{{$gallery->judul}}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <a>Foto</a>
                                        <input name="idImg" value="{{$gallery->image[0]->id}}" hidden>
                                        <div class="">
                                            <input type="file"  onchange="" id="image" class="image" data-min-height="10"
                                                   data-height="150" data-default-file="{{ $gallery->image[0]->url }}"
