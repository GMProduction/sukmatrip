...
<?php $__env->startSection('morecss'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/etc/dropzone.min.css')); ?>" type="text/css">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="dropzonePenginapan" action="<?php echo e(route('dropzone.penginapan')); ?>" class="dropzone" enctype="multipart/form-data">
